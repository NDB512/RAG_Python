        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "Hỗ trợ nhiều loại hợp đồng khác nhau (thuê đất, mượn tiền, mua bán, lao động...). "
                    "Luôn tóm tắt ngắn gọn, diễn đạt lại bằng lời, có cấu trúc rõ ràng. "
                    "Không copy nguyên văn dài dòng. "
                    "Không suy diễn, không thêm thông tin không có trong tài liệu."
                ),
            },
...
""",
    ...
    QueryIntent.SUMMARY: """\
Tóm tắt ngắn gọn, rõ ràng và có cấu trúc nội dung hợp đồng liên quan đến câu hỏi.
**Không copy nguyên văn dài dòng**, hãy diễn đạt lại bằng lời ngắn gọn, dễ hiểu.

Cấu trúc trả lời:
- Giới thiệu ngắn về hợp đồng (nếu cần)
- **Nghĩa vụ / Quyền lợi của Bên A / Bên cho thuê / Bên cho mượn**: 
- **Nghĩa vụ / Quyền lợi của Bên B / Bên thuê / Bên mượn**:
- **Các quy định quan trọng khác** (thời hạn, điều kiện chấm dứt, cam kết chung...):

Chỉ dựa vào nội dung tài liệu được cung cấp, giữ tính chính xác cao. Không suy diễn.
...
Liệt kê **chính xác** nghĩa vụ và quyền lợi của các bên theo hợp đồng.
Hợp đồng loại: {contract_type}

Cấu trúc rõ ràng:
**Nghĩa vụ / Quyền của Bên A (hoặc Bên cho thuê, Bên cho mượn):**
- ...

**Nghĩa vụ / Quyền của Bên B (hoặc Bên thuê, Bên mượn):**
- ...

**Cam kết chung / Quy định khác:**
- ...

Chỉ dựa vào nội dung tài liệu, không thêm thông tin ngoài.
...
Trích dẫn đầy đủ và giải thích nội dung điều khoản được hỏi.
Nếu có nhiều khoản, liệt kê rõ ràng từng khoản.
...
def answer_question(query: str) -> tuple[str, list, list]:
    ...
    try:
        ...
        prompt = template.format(context_user=context_user, context_legal=context_legal, query=query)
